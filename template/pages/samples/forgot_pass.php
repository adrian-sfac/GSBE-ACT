                ...
                <div class="col-lg-4 mx-auto">
                    ...
                    <form class="pt-3" method="POST" action="forgot_exe.php">
                        <div class="form-group">
                            <input type="email" name="email" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Enter Email Address" required>
                        </div>
                        <div class="mt-3">
                            <center><button type="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" name="btn_login">Submit</button></center>
                        </div>
                    </form>
                    </div>
                        </div>

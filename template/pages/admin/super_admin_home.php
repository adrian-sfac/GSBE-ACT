...
?>
                    ...
                    <div class="home-tab">
                      <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                        <ul class="nav nav-tabs" role="tablist">
                          <li class="nav-item">
                            <a class="nav-link active ps-0" id="home-tab" data-bs-toggle="tab" href="#overview" role="tab" aria-controls="overview" aria-selected="true">Books</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" id="profile-tab" data-bs-toggle="tab" href="#audiences" role="tab" aria-selected="false">E-Books</a>
                          </li>
      <!--  (HIDDEN) ===== LAZO                  
                          <li class="nav-item">
                            ...
                            <div class="col-sm-12">
                              <div class="statistics-details d-flex align-items-top justify-content-between">
                                <div>
                                  ...
                                  <h3 class="rate-percentage">5689</h3>
      <!-- (HIDDEN) ====LAZO =====
      ...
      -->
                                ...
                                <div>
                                  ...
                                  <h3 class="rate-percentage">807</h3>
      <!-- (HIDDEN) ====LAZO =====
                                  <p class="text-success d-flex"><i class="mdi mdi-menu-up"></i><span>+0.1%</span></p>
      -->
                                </div>
                                <div>
                                  <p class="statistics-title">Total Special Collection</p>
                                  <h3 class="rate-percentage">158</h3>
      <!-- (HIDDEN) ====LAZO =====                            
      ...
      -->
        ...
        <script src="../../css/vendors/bootstrap-datepicker/bootstrap-datepicker.min.js"></script>
        <script src="../../css/vendors/progressbar.js/progressbar.min.js"></script>
